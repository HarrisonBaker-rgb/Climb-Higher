...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Emgu.CV.Platform.Maui.UI.CameraCaptureSessionCallback, Emgu.CV.Platform.Maui.UI", CameraCaptureSessionCallback.class, __md_methods);
	}
	...
	public CameraCaptureSessionCallback ()
	{
		...
		if (getClass () == CameraCaptureSessionCallback.class) {
			mono.android.TypeManager.Activate ("Emgu.CV.Platform.Maui.UI.CameraCaptureSessionCallback, Emgu.CV.Platform.Maui.UI", "", this, new java.lang.Object[] {  });
		}
	}
